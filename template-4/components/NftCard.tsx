  ...
  return (
    <div className="border-2 min-h-[300px] sm:py-4 max-w-[250px] rounded-xl  sm:rounded-md ">
      ...
      <div className="px-5 py-3 sm:py-0  sm:-mt-4">
        <h1 className="text-[30px] font-bold font-mono">Heart & Sol</h1>
...
/*   
  ...
  <div className="border-2 h-[430px]  sm:m-10 my-5  max-w-[350px] rounded-xl">
      <div className="relative bg-black ">
        <img src="Rectangle9.png" alt="title" className="rounded-t-xl " />
      </div>
      <div className="px-6 sm:-mt-4 mt-4">
        ...
        <div className="flex justify-between">
          ...
          <button className="buttons rounded-2xl flex px-[1em] py-[.7em]  items-center font-bold">
            BUY NFT
          </button>
        </div>
      </div>
